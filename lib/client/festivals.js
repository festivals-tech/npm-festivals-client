...
var Festivals = function Festivals(client) {
  ...
  var getFestivalEvents = function getFestivalEvents(festivalId, query, callback) {
    logger.args('Festivals.getFestivalEvents:', arguments);

    var promise = festivalsDeferred.getFestivalEvents(festivalId, query);
    deferred.call(promise, callback);
  };
